...
class RejectedCompanyTaskUserApply extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
        return [
            'title' => $this->companyName . ' ' . __('notifications.rejected your apply on the task') . ' ' . $this->companyTaskTitle,
