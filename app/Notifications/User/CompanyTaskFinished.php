...
class CompanyTaskFinished extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
        return [
            'title' => $this->companyName . ' ' . __('notifications.company finished the task') . ' ' . $this->companyTaskTitle,
