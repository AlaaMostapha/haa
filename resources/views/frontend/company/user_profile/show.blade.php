            ...
            <div class="prof-box col-lg-8 col-md-7 col-xs-12">
                ...
                <div class="box-item col-xs-12">
                    ...
                    <div class="it-body row">
                        ...
                        <span class="col-xl-6 text-right space-between border-bottom-gray mb-half language-wrap">
                           <span class="language"> {{($language->language_name !='other') ? $language->language_name : $language->language_other}}</span>
                ...
                <div class="box-item col-xs-12">
                    ...
                    <div class="it-body col-xs-12 d-flex oveflow-x-scroll">
                        ...
                        <div class="col-xl-4 col-md-6 col-xs-12 text-right">
                            <div class=" default-border mb-2">
                                ...
                                <h4 class="border-bottom-gray col-12">
                                    <div class="row">
                                    <span class="font-bold col-md-6">{{$certificate->certificate_from}}</span>
                                   <span class="font-bold purple col-md-6 ">{{$certificate->certificate_date}}</span>
                                    </div>
                                </h4>
                                <p class="col-12">
                ...
                <div class="box-item col-xs-12">
                    ...
                    <div class="it-body col-xs-12 d-flex oveflow-x-scroll">
                        ...
                        <div class="col-xl-4 col-md-6 text-right">
                            <div class=" default-border mb-2">
                                <span  class="col-12 d-flex">
                                ...
                                <h4 class="border-bottom-gray col-12">
                                   <div class="row">
                                   <span class="font-bold col-md-6"> {{$experience->experience_from}} </span>
                                    <span class="font-bold purple col-md-6"> {{$experience->experience_date}}</span>
                                   </div>
                                </h4>
                                <p class="col-12">
                ...
                <div class="box-item col-xs-12">
                    <div class="it-head col-xs-12">
                        <h3>{{ __('companytask.Past Projects') }} <span style="color: #585858; font-size: 20px;"id="userProjectsCount">({{optional($user)->projects()->count()}}) <span></h3>
                    </div>
                    <div class="it-body col-xs-12">
                        <div class="p-project col-xs-12" id="post_data_projects">
                            ...
                            <button
                            id="load_more_projects_button"
                            task-user-apply-id="{{$userProjects[count($userProjects) -1]->id}}"
                            taskidcount-raw="{{$userProjects->count()}}"
                            url="{{route('user.loadmore.project')}}"
                ...
                <div class="box-item col-xs-12">
                    ...
                    <div class="it-body col-xs-12">
                        <div class="p-tasks custom-tabel col-xs-12 table-responsive border-none">
                            <table class="table userTable" id="data-table-th">
                                <thead>
                                    <tr>
